...
static void virtio_fs_wake_forget_and_unlock(struct fuse_iqueue *fiq,bool __unused)
__releases(fiq->lock)
{
...
static void virtio_fs_wake_interrupt_and_unlock(struct fuse_iqueue *fiq,bool __unused)
__releases(fiq->lock)
{
	/*
	 * TODO interrupts.
...
static void virtio_fs_wake_pending_and_unlock(struct fuse_iqueue *fiq,bool __unused)
__releases(fiq->lock)
{
